...
public class OSSClientUtil {
    ...
    public static URL picOSS(byte buf[],String  fileName) {
        String endpoint = OSSClientUtil.endpoint;
        // 云账号AccessKey有所有API访问权限，建议遵循阿里云安全最佳实践，创建并使用RAM子账号进行API访问或日常运维，请登录
        // https://ram.console.aliyun.com 创建
        String accessKeyId = OSSClientUtil.accessKeyId;
        String accessKeySecret = OSSClientUtil.accessKeySecret;
        // 创建OSSClient实例
